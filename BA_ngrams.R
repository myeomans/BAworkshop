...
dfm3<-BA_dfm(review_dat$text,ngrams=1) %>%
...
review_dat_dfm_train<-BA_dfm(review_dat_train$text,ngrams=1)

review_dat_dfm_test<-BA_dfm(review_dat_test$text,ngrams=1) %>%
